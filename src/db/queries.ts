...
// checks if folder with id: folderId already has a folder with name: folderName
export async function folderNameAlreadyExists(parentFolderId: number, folderName: string): Promise<Boolean> {
